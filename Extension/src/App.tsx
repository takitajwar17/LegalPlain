...
import { AICapabilities, SimplificationLevel } from "./types";
...
function App() {
  ...
  const [simplificationLevel, setSimplificationLevel] =
    useState<SimplificationLevel>("moderate");
  const [selectedLanguage, setSelectedLanguage] = useState<string>("en");
  const [isControlsExpanded, setIsControlsExpanded] = useState(true);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [aiCapabilities, setAICapabilities] = useState<AICapabilities | null>(
    null
  );
  ...
  return (
    ...
    >
      ...
      <header
        ...
        } backdrop-blur-sm sticky top-0 z-10 border-b ${
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={toggleTheme}
              className={`p-2 ${
                isDark ? "hover:bg-purple-500/10" : "hover:bg-purple-100"
          ...
          <>
            ...
            >
              <button
                ...
                title={
                  isControlsExpanded ? "Collapse settings" : "Expand settings"
                }
              >
                <span
