...
const testimonials = [
  {
    ...
    content:
      "PlainLegal has transformed how I handle contracts. What used to take hours of back-and-forth with lawyers now takes minutes to understand.",
    rating: 5,
  },
  {
    name: "Michael Chen",
    ...
    content:
      "The accuracy and clarity provided by PlainLegal is remarkable. It's like having a legal expert right in your browser.",
    rating: 5,
  },
  {
    ...
    content:
      "As a freelancer, understanding client contracts is crucial. PlainLegal gives me the confidence to navigate legal documents independently.",
    rating: 5,
  },
];
